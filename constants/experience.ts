export const experiences = [

    {
        ...
        description1: "I build and maintain both frontend and backend features for the Beauty Butler platform. I design responsive, user-friendly interfaces and ensure accessibility standards are met. On the backend, I develop scalable APIs, optimize performance, and manage data using SQL, Redis, and cloud infrastructure. I work closely with designers and other engineers to ship reliable features that improve user experience and support business growth.",
