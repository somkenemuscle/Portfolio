          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              ...
              <p className="mt-6 text-lg  font-light leading-8 ">
                ...
                solve real-world problems.  Believe me when I say, <span className="font-semibold text-gray-500">"coding isn't just a job for me, it's a hobby that I love and enjoy deeply".</span>
              </p>
