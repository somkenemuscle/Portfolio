...
const Navbar = () => {
    ...
    return (
        <div className="fixed z-50 top-6 inset-x-0 mx-auto w-fit">
            <nav className="bg-neutral-950 rounded-xl text-orange-50 font-sans text-sm px-6 py-2 navbar glowing-border">
                <ul className="flex flex-row items-center gap-x-8 cursor-pointer font-light">
                    <li>About</li>
                    <li>Projects</li>
                    <li>Resume</li>
                    <li>Contact</li>
                    <li className="bg-orange-50 text-black rounded-xl px-4 py-2 hover:bg-orange-200">
